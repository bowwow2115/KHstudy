...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		<a class="navbar-brand" href="/">Lee's World</a>
		...
		<div class="collapse navbar-collapse" id="navbarColor01">
			...
			data-toggle="modal" data-target=".modal">로그인</button>
				...
				<form action="/login" method="post" name="loginFrm">
					<div class="modal-body">
						<div class="form-group">
							...
							name="memberId" id="memberId" placeholder="아이디입력">
						</div>
						<div class="form-group">
							<label for="memberPw">비밀번호</label>
							<input type="password" class="form-control" 
							name="memberPw" id="memberPw" placeholder="비밀번호입력">
						</div>
					</div>
