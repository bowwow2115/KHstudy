      ...
      <form action="/Join" method="post" name="joinFrm">
        <fieldset>
          ...
          <div class="form-group">
            <label class="control-label" for="memberId" style="display: block"
              >아이디<span id="ajaxCheck"></span
            ></label>
            <input
              type="text"
              name="memberId"
            ...
            />
            <button type="button" id="idChk" class="btn btn-secondary">
              중복체크
            </button>
          </div>
          <div class="form-group">
